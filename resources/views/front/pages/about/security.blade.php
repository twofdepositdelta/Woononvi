            ...
            <div class="col-lg-6">
                <div class="security-right wow fadeInRight" data-wow-delay=".25s">
                    ...
                    <p class="security-text">
                        La sécurité commence par la confiance. Chez Wononvi, nous effectuons une vérification minutieuse de chaque profil utilisateur. Avant de rejoindre notre communauté, chaque membre passe par un processus de validation d'identité, garantissant ainsi que seuls des individus de confiance peuvent proposer ou rechercher des trajets. Ce système de vérification contribue à instaurer un climat de sécurité pour que chacun puisse partager un trajet en toute sérénité.
                    </p>
                </div>
            </div>
        </div>
