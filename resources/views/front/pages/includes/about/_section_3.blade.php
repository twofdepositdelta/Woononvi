<div class="vision-area mb-5 pb-20 bg-light" id="vision">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="vision-content wow fadeInLeft" data-wow-delay=".25s">
                    <div class="site-heading mb-3 mt-5">
                        <span class="site-title-tagline justify-content-start">
                            <i class="flaticon-vision"></i> Notre Vision
                        </span>
                        <h2 class="site-title">
                            Construire un <span>Avenir Durable</span> grâce au Covoiturage
                        </h2>
                    </div>
                    <p class="vision-text">
            ...
            <div class="col-lg-6">
                <div class="mission-content wow fadeInRight" data-wow-delay=".25s">
                    <div class="site-heading mb-3 mt-5">
                        <span class="site-title-tagline justify-content-start">
                            <i class="flaticon-target"></i> Notre Mission
                        </span>
                        <h2 class="site-title">
                            Rendre le Covoiturage Accessible, Sécurisé et Écologique
                        </h2>
                    </div>
