        ...
        <div class="row gy-4">
            <div class="col-lg-5">
                <div class="user-grid-card position-relative border radius-16 overflow-hidden bg-base h-100">
                    <img src="{{ asset('storage/back/assets/images/user-grid/user-grid-bg' . (Auth::user()->profile->genre == 'male' ? '10' : '7') . '.png') }}" alt="" class="w-100 object-fit-cover">
                    {{-- <img src="{{ asset('storage/back/assets/images/user-grid/user-grid-bg'. Auth::user()->profile->genre == 'male' ? '10' : '7' .'.png') }}" alt="" class="w-100 object-fit-cover"> --}}
                    <div class="pb-24 ms-16 mb-24 me-16 mt--100">
                        <div class="text-center border border-top-0 border-start-0 border-end-0">
                            <img src="{{ asset(Auth::user()->profile->avatar ? Auth::user()->profile->avatar : 'storage/back/assets/images/user-grid/user-grid-img14.png') }}" alt=""
                                class="border br-white border-width-2-px w-200-px h-200-px rounded-circle object-fit-cover">
                            <h6 class="mb-0 mt-16">{{ strtoupper(Auth::user()->lastname) . ' ' . ucfirst(strtolower(Auth::user()->firstname)) }}</h6>
                        ...
                        <div class="mt-24">
                            ...
                            <ul>
                                <li class="d-flex align-items-center gap-1 mb-12">
                                    ...
                                    <span class="w-70 text-secondary-light fw-medium">: {{ strtoupper(Auth::user()->lastname) . ' ' . ucfirst(strtolower(Auth::user()->firstname)) }}</span>
                                </li>
                                <li class="d-flex align-items-center gap-1 mb-12">
                                ...
                                <li class="d-flex align-items-center gap-1 mb-12">
                                    ...
                                    <span class="w-70 text-secondary-light fw-medium">: {{ Auth::user()->phone ?? 'N/A' }}</span>
                                </li>
                                <li class="d-flex align-items-center gap-1 mb-12">
                                    <span class="w-30 text-md fw-semibold text-primary-light">Naissance</span>
                                    <span class="w-70 text-secondary-light fw-medium">: {{ Auth::user()->date_of_birth ? ucfirst(\Carbon\Carbon::parse(Auth::user()->date_of_birth)->locale('fr_FR')->translatedFormat('D d M Y')) : 'N/A' }}</span>
                                </li>
                                @if (Auth::user()->gender)
                                    <li class="d-flex align-items-center gap-1 mb-12">
                                        <span class="w-30 text-md fw-semibold text-primary-light">Genre</span>
                                        <span class="w-70 text-secondary-light fw-medium">: {{ Auth::user()->gender == 'male' ? 'Homme' : 'Femme' }}</span>
                                    </li>
                                @endif
                                <li class="d-flex align-items-center gap-1 mb-12">
                                ...
                                <li class="d-flex align-items-center gap-1 mb-12">
                                    ...
                                    <span class="w-70 text-{{ Auth::user()->is_verified == true ? 'success' : 'danger' }} fw-medium">: {{ Auth::user()->is_verified ? 'Vérifié' : 'Non Vérifié' }}</span>
                                </li>
                                <li class="d-flex align-items-center gap-1">
                                    <span class="w-30 text-md fw-semibold text-primary-light">Adresse</span>
                                    <span class="w-70 text-secondary-light fw-medium">: {{ Auth::user()->profile->address ?? 'N/A' }}</span>
                                </li>
                                <li class="d-flex align-items-center gap-1 mb-12">
                                    <span class="w-30 text-md fw-semibold text-primary-light">Depuis le</span>
                                    <span class="w-70 text-secondary-light fw-medium">: {{ ucfirst(\Carbon\Carbon::parse(Auth::user()->created_at)->locale('fr_FR')->translatedFormat('D d M Y')) }}</span>
                                </li>
                                ...
                                <li class="d-flex align-items-center gap-1">
                                    ...
                                    <span class="w-70 text-secondary-light fw-medium">: {{ Auth::user()->profile->bio ?? 'N/A' }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
