...
<div id="kt_app_header" class="app-header " data-kt-sticky="true"
    ...
    <div class="app-container  container-fluid d-flex align-items-stretch flex-stack "
        ...
        <div class="d-flex align-items-center d-block d-lg-none ms-n3" title="Show sidebar menu">
            ...
            <!--begin::Logo image-->
            <a href="index.html">
                <img alt="Logo" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/logos/star.svg') }}" class="h-30px theme-light-show" />
                <img alt="Logo" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/logos/star-dark.svg') }}" class="h-30px theme-dark-show" />
            </a>
            <!--end::Logo image-->
        </div>
        <!--end::Sidebar toggle-->
        ...
        <div class="app-navbar flex-lg-grow-1" id="kt_app_header_navbar">
                                ...
                                <div class="scroll-y mh-200px mh-lg-350px">
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-6.jpg') }}" alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-2.jpg') }}" alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-9.jpg') }}" alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-14.jpg') }}" alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-11.jpg') }}" alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/brand-logos/volicity-9.svg') }}"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/brand-logos/tvit.svg') }}" alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/misc/infography.svg') }}" alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/brand-logos/leaf.svg') }}" alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/brand-logos/tower.svg') }}" alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                            ...
                            <div class="d-flex flex-column px-9">
                                ...
                                <div class="text-center px-4">
                                    <img class="mw-100 mh-200px" alt="image"
                                        src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/illustrations/sigma-1/1.png') }}" />
                                </div>
                                <!--end::Illustration-->
                            </div>
                            <!--end::Wrapper-->
            ...
            <div class="app-navbar-item me-2 ms-1 ms-md-2" id="kt_header_user_menu_toggle">
                ...
                <div class="cursor-pointer symbol symbol-circle symbol-35px ms-3"
                    data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
                    data-kt-menu-placement="bottom-end">
                    <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-3.jpg') }}" alt="user" />
                </div>
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <img alt="Logo" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-3.jpg') }}" />
                            </div>
                            <!--end::Avatar-->
                            ...
                            <span class="menu-title position-relative">
                                ...
                                <span
                                    ...
                                    English <img class="w-15px h-15px rounded-1 ms-2"
                                        src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/flags/united-states.svg') }}" alt="" />
                                </span>
                            </span>
                        </a>
                        ...
                        <div class="menu-sub menu-sub-dropdown w-175px py-4">
                            ...
                            <div class="menu-item px-3">
                                <a href="account/settings.html" class="menu-link d-flex px-5 active">
                                    <span class="symbol symbol-20px me-4">
                                        <img class="rounded-1" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/flags/united-states.svg') }}"
                                            alt="" />
                                    </span>
                                    English
                                </a>
                            ...
                            <div class="menu-item px-3">
                                <a href="account/settings.html" class="menu-link d-flex px-5">
                                    <span class="symbol symbol-20px me-4">
                                        <img class="rounded-1" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/flags/spain.svg') }}" alt="" />
                                    </span>
                                    Spanish
                                </a>
                            </div>
                            ...
                            <div class="menu-item px-3">
                                <a href="account/settings.html" class="menu-link d-flex px-5">
                                    <span class="symbol symbol-20px me-4">
                                        <img class="rounded-1" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/flags/germany.svg') }}"
                                            alt="" />
                                    </span>
                                    German
                                </a>
                            ...
                            <div class="menu-item px-3">
                                <a href="account/settings.html" class="menu-link d-flex px-5">
                                    <span class="symbol symbol-20px me-4">
                                        <img class="rounded-1" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/flags/japan.svg') }}" alt="" />
                                    </span>
                                    Japanese
                                </a>
                            </div>
                            ...
                            <div class="menu-item px-3">
                                <a href="account/settings.html" class="menu-link d-flex px-5">
                                    <span class="symbol symbol-20px me-4">
                                        <img class="rounded-1" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/flags/france.svg') }}" alt="" />
                                    </span>
                                    French
                                </a>
                            </div>
            ...
            <div class="app-navbar-item ms-1 ms-md-2 me-n3">
                ...
                <a href="authentication/sign-in/basic.html"
                    ...
                    <i class="ki-duotone ki-exit-right fs-2x"><span class="path1"></span><span
                            class="path2"></span></i>
                </a>
                <!--end::Link-->
            </div>
