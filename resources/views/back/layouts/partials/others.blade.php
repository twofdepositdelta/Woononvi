        ...
        <div class="card-body position-relative" id="kt_app_layout_builder_body">
            ...
            <div id="kt_app_settings_content" class="position-relative scroll-y me-n5 pe-5" data-kt-scroll="true"
                ...
                <form class="form" method="POST" id="kt_app_layout_builder_form"
                    action="https://preview.keenthemes.com/star-html-pro/index.php">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="fw-semibold text-muted fs-7 d-block lh-1">
                                    ...
                                    <a class="fw-semibold"
                                        href="https://preview.keenthemes.com/html/star-html-pro/docs/getting-started/dark-mode"
                            ...
                            <div class="row " data-kt-buttons="true"
                                ...
                                <div class="col-6">
                                    ...
                                    <label class="form-check-image form-check-success">
                                        ...
                                        <div class="form-check-wrapper border-gray-200 border-2">
                                            <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/preview/light.png') }}" class="mw-100 mh-250px" alt="" />
                                        </div>
                                        <!--end::Image-->
                                ...
                                <div class="col-6">
                                    ...
                                    <label class="form-check-image form-check-success">
                                        <!--begin::Image-->
                                        <div class="form-check-wrapper border-gray-200 border-2">
                                            <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/preview/dark.png') }}" class="mw-100 mh-250px" alt="" />
                                        </div>
                                        <!--end::Image-->
                        ...
                        <div class="form-group d-flex flex-stack">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="fs-7 fw-semibold text-muted">
                                    ...
                                    <a class="fw-semibold"
                                        href="https://preview.keenthemes.com/html/star-html-pro/docs/getting-started/rtl"
                                        target="_blank">See docs</a>
                                </div>
                            </div>
                            <!--end::Heading-->
                        ...
                        <div class="form-group ">
                            ...
                            <div class="d-flex flex-column mb-4">
                                ...
                                <div>
                                    ...
                                    <a class="fw-semibold"
                                        href="https://preview.keenthemes.com/html/star-html-pro/docs/icons/keenicons"
...
<button id="kt_app_layout_builder_toggle" class="btn btn-dark app-layout-builder-toggle lh-1 py-4 "
    title="Star HTML Pro Builder" data-bs-custom-class="tooltip-inverse" data-bs-toggle="tooltip"
                            ...
                            <div class="pe-3 mb-5">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                        ...
                                        <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-14.jpg') }}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                            ...
                            <div class="overflow-auto pb-5">
                                ...
                                <div
                                    ...
                                    <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px">
                                            <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-2.jpg') }}" alt="img" />
                                        </div>
                                        <!--end::User-->
                                ...
                                <div
                                    ...
                                    <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                        <!--begin::User-->
                                        <div class="symbol symbol-circle symbol-25px">
                                            <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-20.jpg') }}" alt="img" />
                                        </div>
                                        <!--end::User-->
                            ...
                            <div class="overflow-auto pe-3">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                        ...
                                        <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-1.jpg') }}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                            ...
                            <div class="mb-5 pe-3">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                        ...
                                        <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-23.jpg') }}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                            ...
                            <div class="overflow-auto pb-5">
                                <div
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        <!--begin::Icon-->
                                        <img alt="" class="w-30px me-3" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/files/pdf.svg') }}" />
                                        <!--end::Icon-->
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        <!--begin::Icon-->
                                        <img alt="/star-html-pro/apps/projects/project.html" class="w-30px me-3"
                                            src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/files/doc.svg') }}" />
                                        <!--end::Icon-->
                                    ...
                                    <div class="d-flex flex-aligns-center">
                                        <!--begin::Icon-->
                                        <img alt="/star-html-pro/apps/projects/project.html" class="w-30px me-3"
                                            src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/files/css.svg') }}" />
                                        <!--end::Icon-->
                            ...
                            <div class="overflow-auto pb-5">
                                <div
                                    ...
                                    <div class="overlay me-10">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px"
                                                src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/stock/600x400/img-29.jpg') }}" />
                                        </div>
                                        <!--end::Image-->
                                    ...
                                    <div class="overlay me-10">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px"
                                                src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/stock/600x400/img-31.jpg') }}" />
                                        </div>
                                        <!--end::Image-->
                                    ...
                                    <div class="overlay">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px"
                                                src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/stock/600x400/img-40.jpg') }}" />
                                        </div>
                                        <!--end::Image-->
                            ...
                            <div class="pe-3 mb-5">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                        ...
                                        <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-4.jpg') }}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                    ...
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                    src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-25.jpg') }}" /></div>
                            <!--end::Avatar-->
                            <!--begin::Details-->
                            <div class="ms-3">
                ...
                <div class="d-flex justify-content-end mb-10 ">
                    ...
                    <div class="d-flex flex-column align-items-end">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <!--begin::Avatar-->
                            <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                    src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-1.jpg') }}" /></div>
                            <!--end::Avatar-->
                        </div>
                        <!--end::User-->
        ...
        <div class="card-body hover-scroll-overlay-y h-400px pt-5">
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                    <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/stock/600x400/img-1.jpg') }}" alt="" />
                </div>
                <!--end::Pic-->
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex flex-stack">
                ...
                <!--begin::Pic-->
                <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                    <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/stock/600x400/img-3.jpg') }}" alt="" />
                </div>
                <!--end::Pic-->
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex flex-stack">
                ...
                <!--begin::Pic-->
                <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                    <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/stock/600x400/img-8.jpg') }}" alt="" />
                </div>
                <!--end::Pic-->
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex flex-stack">
                ...
                <!--begin::Pic-->
                <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                    <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/stock/600x400/img-26.jpg') }}" alt="" />
                </div>
                <!--end::Pic-->
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex flex-stack">
                ...
                <!--begin::Pic-->
                <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                    <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/stock/600x400/img-21.jpg') }}" alt="" />
                </div>
                <!--end::Pic-->
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex flex-stack">
                ...
                <!--begin::Pic-->
                <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                    <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/stock/600x400/img-34.jpg') }}" alt="" />
                </div>
                <!--end::Pic-->
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex flex-stack">
                ...
                <!--begin::Pic-->
                <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                    <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/stock/600x400/img-27.jpg') }}" alt="" />
                </div>
                <!--end::Pic-->
            </div>
            <!--end::Item-->
...
<div id="kt_explore" class="explore bg-body" data-kt-drawer="true" data-kt-drawer-name="explore"
    data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'lg': '440px'}"
            ...
            <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto"
                ...
                <div class="rounded border border-dashed border-gray-300 py-6 px-8 mb-5">
                    ...
                    <div class="d-flex flex-column flex-center mb-3">
                        ...
                        <div class="mb-2">
                            <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/payment-methods/paypal.svg') }}" alt=""
                                class="h-30px me-3 rounded-1" />

                            <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/payment-methods/visa.svg') }}" alt="" class="h-30px me-3 rounded-1" />

                            <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/payment-methods/mastercard.svg') }}" alt=""
                                class="h-30px me-3 rounded-1" />

                            <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/payment-methods/americanexpress.svg') }}" alt=""
    ...
    <div class="card shadow-none rounded-0 w-100">
        ...
        <div class="card-body" id="kt_help_body">
            ...
            <div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true" data-kt-scroll-height="auto"
                ...
                <!--begin::Link-->
                <a href="https://preview.keenthemes.com/html/star-html-pro/docs"
                ...
                <!--end::Link-->
                <!--begin::Link-->
                <a href="https://preview.keenthemes.com/html/star-html-pro/docs/base/utilities"
                    class="parent-hover d-flex align-items-center mb-7">
                    <!--begin::Icon-->
                    <div
                ...
                <!--end::Link-->
                <!--begin::Link-->
                <a href="https://preview.keenthemes.com/html/star-html-pro/docs/getting-started/changelog"
                    class="parent-hover d-flex align-items-center mb-7">
                    <!--begin::Icon-->
                    <div
...
<div class="engage-toolbar d-flex position-fixed px-5 fw-bold zindex-2 top-50 end-0 transform-90 mt-5 mt-lg-20 gap-2">
    ...
    <button id="kt_explore_toggle" class="engage-explore-toggle engage-btn btn shadow-sm fs-6 px-4 rounded-top-0"
        title="Explore Star HTML Pro" data-bs-custom-class="tooltip-inverse" data-bs-toggle="tooltip"
        data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover">
    ...
    <!--begin::Purchase link-->
    <a href="https://keenthemes.com/products/star-html-pro" target="_blank"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="btn btn-light-primary fw-bold w-100 mb-8">
                    <img alt="Logo" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/brand-logos/google-icon.svg') }}" class="h-20px me-3" />
                    ...
                    <div class="mh-300px scroll-y me-n7 pe-7">
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-6.jpg') }}" />
                                </div>
                                <!--end::Avatar-->
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-1.jpg') }}" />
                                </div>
                                <!--end::Avatar-->
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-5.jpg') }}" />
                                </div>
                                <!--end::Avatar-->
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-25.jpg') }}" />
                                </div>
                                <!--end::Avatar-->
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-9.jpg') }}" />
                                </div>
                                <!--end::Avatar-->
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-23.jpg') }}" />
                                </div>
                                <!--end::Avatar-->
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-12.jpg') }}" />
                                </div>
                                <!--end::Avatar-->
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-13.jpg') }}" />
                                </div>
                                <!--end::Avatar-->
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/avatars/300-21.jpg') }}" />
                                </div>
                                <!--end::Avatar-->
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/card-logos/visa.svg') }}" alt="" class="h-25px" />
                                                <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/card-logos/mastercard.svg') }}" alt=""
                                                    class="h-25px" />
                                                <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/svg/card-logos/american-express.svg') }}" alt=""
                                                    class="h-25px" />
                                            </div>
                                            <!--end::Card logos-->
                                        </div>
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100 text-center">
                                    ...
                                    <div class="text-center px-4 py-15">
                                        <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/illustrations/sigma-1/9.png') }}" alt=""
                    ...
                    <div class="py-5">
                        ...
                        <div data-kt-search-element="empty" class="text-center d-none">
                            ...
                            <div class="text-center px-5">
                                <img src="{{ asset(BackHelper::getEnvFolder() . 'storage/back/assets/media/illustrations/sigma-1/1.png') }}" alt=""
