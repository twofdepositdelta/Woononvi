                            ...
                            <div class="card-slider">
                                <div class="p-20 h-240-px radius-8 overflow-hidden position-relative z-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-between h-100">
                                        ...
                                        <div>
                                            <span
                                                class="text-white text-xs fw-normal text-opacity-75">Credit
                                                Card Number</span>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div>
                                                <span
                                                    class="text-white text-xs fw-normal text-opacity-75">Name</span>
                                                <h6 class="text-white text-xl fw-semibold mb-0">Arlene McCoy
                                                </h6>
                                            </div>
                                            <div>
                                                <span
                                                    class="text-white text-xs fw-normal text-opacity-75">Exp.
                                                    Date</span>
                    ...
                    <div class="card-body p-24">
                        ...
                        <ul class="nav nav-pills pill-tab mb-24 mt-28 border input-form-light p-1 radius-8 bg-neutral-50"
                            ...
                            <li class="nav-item w-50" role="presentation">
                                <button
                                    class="nav-link px-12 py-10 text-md w-100 text-center radius-8 active"
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-Buy" role="tabpanel"
                                ...
                                <div class="mb-20">
                                    <label for="estimatedValue"
                                        ...
                                        Value</label>
                                    <div
                                        class="input-group input-group-lg border input-form-light radius-8">
                                ...
                                <div class="mb-20">
                                    <label for="tradeValue"
                                        class="fw-semibold mb-8 text-primary-light">Trade Value</label>
                                    <div
                                        class="input-group input-group-lg border input-form-light radius-8">
                                        <input type="text" class="form-control bg-base border-0 radius-8"
                                ...
                                <div class="mb-20">
                                    ...
                                    <textarea class="form-control bg-base h-80-px radius-8"
                            ...
                            <div class="tab-pane fade" id="pills-Sell" role="tabpanel"
                                ...
                                <div class="mb-20">
                                    ...
                                    <textarea class="form-control h-80-px radius-8"
                                        placeholder="Enter Address"></textarea>
                                </div>
                                <div class="mb-24">
                                    <span class="mb-4 text-sm text-secondary-light">Total Balance</span>
