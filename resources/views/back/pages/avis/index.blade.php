               ...
               <tbody>
                   ...
                   @else
                       ...
                       <tr>
                           ...
                           <td> <a href="{{ route('rides.show',$review->booking->ride->numero_ride) }}">{{ $review->booking->ride->start_location_name }} - {{ $review->booking->ride->end_location_name }}</a></td> <!-- Affiche le trajet -->
