    ...
    <div class="card h-100">
        <div class="card-body p-24">
                ...
                <ul class="nav border-gradient-tab nav-pills mb-0" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link d-flex align-items-center active" id="pills-to-do-list-tab" data-bs-toggle="pill" data-bs-target="#pills-to-do-list" type="button" role="tab" aria-controls="pills-to-do-list" aria-selected="true">
                            ...
                            <span class="text-sm fw-semibold py-6 px-12 bg-neutral-500 rounded-pill text-white line-height-1 ms-12 notification-alert">{{ BackHelper::getTodayRidesTotal() }}</span>
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link d-flex align-items-center" id="pills-recent-leads-tab" data-bs-toggle="pill" data-bs-target="#pills-recent-leads" type="button" role="tab" aria-controls="pills-recent-leads" aria-selected="false" tabindex="-1">
                            ...
                            <span class="text-sm fw-semibold py-6 px-12 bg-neutral-500 rounded-pill text-white line-height-1 ms-12 notification-alert">{{ backHelper::getTodayBookingsTotal() }}</span>
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link d-flex align-items-center" id="pills-recent-users-tab" data-bs-toggle="pill" data-bs-target="#pills-users-leads" type="button" role="tab" aria-controls="pills-recent-leads" aria-selected="false" tabindex="-1">
                            Dernières inscriptions
                            <span class="text-sm fw-semibold py-6 px-12 bg-neutral-500 rounded-pill text-white line-height-1 ms-12 notification-alert">{{ backHelper::showLastFiftyUsersTotal() }}</span>
                        </button>
                    </li>
                </ul>
                <a href="{{ route('tarjets.cartograpie') }}" class="text-primary-600 hover-text-primary d-flex align-items-center gap-1">
                    Vue d'ensemble
            ...
            <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset($ride->driver->profile->avatar) }}" alt="Avatar" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                                <div class="flex-grow-1">
                                                    <h6 class="text-md mb-0 fw-medium">{{ $ride->driver->lastname . ' ' . $ride->driver->firstname }}</h6>
                                                    <span class="text-sm text-secondary-light fw-medium">{{ $ride->driver->phone }}</span>
                                                </div>
                                            </div>
                                        </td>
                ...
                <div class="tab-pane fade" id="pills-users-leads" role="tabpanel" aria-labelledby="pills-recent-users-tab" tabindex="0">
                    <div class="table-responsive scroll-sm">
                        <table class="table bordered-table sm-table mb-0">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @forelse (backHelper::showLastFiftyUsers() as $user)
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset($user->profile->avatar ?? 'default-avatar.png') }}" alt="Avatar" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                                <div class="flex-grow-1">
                                                    <h6 class="text-md mb-0 fw-medium">{{ $user->lastname . ' ' . $user->firstname }}</h6>
                                                    <span class="text-sm text-secondary-light fw-medium">{{ $user->phone }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>{{ $user->email }}</td>
                                        ...
                                        <td>
                                            <span class="badge {{ $user->status == true ? 'bg-success-600' : 'bg-danger-600' }} text-sm fw-semibold px-20 py-9 radius-4 text-white">
