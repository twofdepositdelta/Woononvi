...
<div class="card h-100 p-0 radius-12">
    ...
    <div class="card-body p-24">
        ...
        <!-- Heure de départ et places disponibles -->
        <div class="row mb-3">
            <div class="col-md-6">
        ...
        <!-- Numéro du trajet, commission et véhicule -->
        <div class="row mb-3">
            <div class="col-md-6 mb-4">
                <strong>Numéro du Trajet :</strong>
            ...
            <div class="col-md-6">
                ...
                <p class="mb-0">{{ $ride->vehicle->vehicle_mark }}</p>
            </div>
        </div>
    </div>
    <!-- /Card Body -->
