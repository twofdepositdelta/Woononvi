...
<div class="card h-100 p-0 radius-12">
    ...
    <div class="card-body p-24">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                @switch($rideRequest->status)
                    ...
                    @case('validated_by_passenger')
                        <span class="badge bg-info">Confirmée par passager</span>
                        @break
                    @case('validated_by_driver')
                        <span class="badge bg-primary">Confirmée par conducteur</span>
                        @break
                    @case('refunded')
            ...
            <div class="col-md-6">
                <strong>Date :</strong>
                <p class="mb-0">{{ \Carbon\Carbon::parse($rideRequest->created_at)->locale('fr')->translatedFormat('D, d M Y, H:i') }}</p>
            </div>
        </div>
        ...
        <div class="row mb-3">
            @if ($rideRequest->accepted_at)
                ...
                <div class="col-md-6">
                    ...
                    <p class="mb-0">
                        {{ $rideRequest->accepted_at ? \Carbon\Carbon::parse($rideRequest->accepted_at)->locale('fr')->translatedFormat('D, d M Y, H:i') : 'Non encore acceptée' }}
                    </p>
                </div>
            @endif
            ...
            <div class="col-md-6">
                ...
                <p class="mb-0">
                    {{ $rideRequest->rejected_at ? \Carbon\Carbon::parse($rideRequest->rejected_at)->locale('fr')->translatedFormat('D, d M Y, H:i') : 'Non encore rejetée' }}
                </p>
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <p class="mb-0">
                    {{ $rideRequest->validated_by_passenger_at ? \Carbon\Carbon::parse($rideRequest->validated_by_passenger_at)->locale('fr')->translatedFormat('D, d M Y, H:i') : 'Non encore validée par passager' }}
                </p>
            </div>
            @endif
            ...
            <div class="col-md-6">
                ...
                <p class="mb-0">
                    {{ $rideRequest->validated_by_driver_at ? \Carbon\Carbon::parse($rideRequest->validated_by_driver_at)->locale('fr')->translatedFormat('D, d M Y, H:i') : 'Non encore validée par conducteur' }}
                </p>
            </div>
