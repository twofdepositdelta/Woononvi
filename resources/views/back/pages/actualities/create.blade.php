                    ...
                    <form action="{{ route('actualities.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-12 mt-5">
                                ...
                                <select class="form-select @error('type_new_id') is-invalid @enderror" id="type_new"
                                    name="type_new_id" required>
                            ...
                            <div class="col-12 d-none" id="role">
                                ...
                                <select class="form-select @error('roles') is-invalid @enderror" name="roles[]"
                                    id="roles" multiple style="width: 100%; height: 150px;">
                                ...
                                <div class="d-flex align-items-center flex-wrap gap-28">
                                    <div class="form-check d-flex align-items-center gap-2">
                                        ...
                                        <input type="radio"
                                            ...
                                            id="published_yes" name="published" value="1">
                                    </div>
                                    <div class="form-check  d-flex align-items-center gap-2">
                                        <label class="form-check-label" for="published_no">Non publié</label>
                                        <input type="radio"
                                            class="form-check-input @error('published') is-invalid @enderror"
                                            id="published_no" name="published" value="0">
                                    </div>
                                </div>
                                @error('published')
                                    <div class="invalid-feedback">{{ $message }}</div>
