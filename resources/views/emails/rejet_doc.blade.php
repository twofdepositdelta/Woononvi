...
<body>
    <div class="container">
        ...
        <div class="content">
            <h1>Bonjour {{ $document->user->firstname }},</h1>

            <p>Votre document intitulé "<strong style="color:#174e6a "> {{ $document->typeDocument->label }}</strong>" a été rejeté pour la raison suivante :</p>
