...
class RideController extends Controller
{
    ...
    public function bookRide(Request $request)
    {
        ...
        $booking = DB::table('bookings')->insert([
            ...
            'passenger_start_location' => $startLocation,  
            'passenger_end_location' => $endLocation, 
    ...
    public function getDriverBookings(Request $request)
    {
        ...
        $query = DB::table('bookings')
            ->select([
                ...
                DB::raw('ST_AsText(bookings.passenger_start_location)'),
                DB::raw('ST_AsText(bookings.passenger_end_location)'),
