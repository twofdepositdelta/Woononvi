...
class RideController extends Controller
{
    ...
    public function bookRide(Request $request)
    {
        ...
        $booking = DB::table('bookings')->insert([
            ...
            'passenger_start_location' => DB::raw("ST_GeomFromText('POINT($startLocation->getLng() $startLocation->getLat())', 4326)"),
            'passenger_end_location' => DB::raw("ST_GeomFromText('POINT($endLocation->getLng() $endLocation->getLat())', 4326)"), 
